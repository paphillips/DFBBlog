/* PrismJS 1.11.0
http://prismjs.com/download.html?themes=prism&languages=asm6502&plugins=line-highlight+line-numbers */
...
/*
Prism.languages.asmcypressdfb = {
	'comment': /\/\*[\s\S]*?\*\//,	// slash asterisk open / close
	'comment2': {
		pattern: /\/\/.*$/,
		alias: 'comment'
	},
	//'commentbold': /\[([^]]+)\]/,
	'opcode': {
		pattern: /\b(?:area|org|dw|acu|addr|dmux|alu|mac|shift|write)\b/,
		alias: 'property'
	},
};
*/
